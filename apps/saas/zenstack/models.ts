...
export type Jwks = $ModelResult<$Schema, "Jwks">;
export type OauthClient = $ModelResult<$Schema, "OauthClient">;
export type OauthRefreshToken = $ModelResult<$Schema, "OauthRefreshToken">;
export type OauthAccessToken = $ModelResult<$Schema, "OauthAccessToken">;
export type OauthConsent = $ModelResult<$Schema, "OauthConsent">;
